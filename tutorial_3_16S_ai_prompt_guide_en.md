...
After assets are ready, run Nano4 preflight with my project <PROJECT_ID> and ngs62g. Upon passing, submit 03_scripts/submit_ampliseq.slurm using Moving Pictures single-end parameters and report Job ID.
```
